...
public class ATreeMap3Test {
    ...
    private ATreeMap3<Integer, Integer> createA() {
        final Random rand = new Random(12345);
        ATreeMap3<Integer, Integer> result = ATreeMap3.empty(Comparator.<Integer>naturalOrder());
    ...
    @Test public void testAddRemove() {
        ...
        final ATreeMap3<Integer, Integer> aMap = createA();
